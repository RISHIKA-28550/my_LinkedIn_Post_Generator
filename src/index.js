...
function generatePost(event) {
  ...
  let prompt = `Write a LinkedIn post. Here is the content idea: ${user_input.value}. Keep it clear, engaging and long with atleast 300-350 words with a blend of bold and italic fonts and you may even increse the count of words ifthe topic requires more explanation or the user wants to elaborate more. Include a powerful opening line and a soft call to action. Please stick to the instructions provided. Include eye-catching emojis and also hashtags at the end we add in linkedin posts.`;
  let context =
